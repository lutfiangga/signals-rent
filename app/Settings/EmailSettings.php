...
class EmailSettings extends SettingsDefinition
{
    ...
    {
        return [
            'mailer' => ['required', 'string', 'in:smtp,ses,mailgun,postmark,resend,brevo,log'],
            ...
            'resend_key' => ['nullable', 'string', 'max:255'],
            'brevo_key' => ['nullable', 'string', 'max:255'],
